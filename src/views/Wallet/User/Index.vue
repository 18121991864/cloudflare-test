...
const tableColumns: ComputedRef<TableColumnType[]> = computed(() => [
    { title: '钱包账户ID', customRender: ({ index }) => `${index + 1}`, width: 80, fixed: 'left' },
    { title: '钱包名称', dataIndex: 'opAccount' },
    { title: '钱包ID', dataIndex: 'opTime' },
    { title: '钱包品牌', dataIndex: 'reqFunc' },
    { title: '代理商ID', dataIndex: 'reqUrl' },
    { title: '管理地址(链/地址/AML污染)', dataIndex: 'reqUrl' },
    { title: '风险备注', dataIndex: 'reqUrl' },
