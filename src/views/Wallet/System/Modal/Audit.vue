...
<template>
    <a-modal v-model:open="visible" title="审核" :confirm-loading="isLoading" @ok="handleOk">
        <a-form ref="formRef" :model="formState" name="basic" :label-col="{ span: 4 }" layout="vertical" autocomplete="off">
            <a-form-item label="账户类型" name="state" :rules="[{ required: true, message: '请选择' }]">
            ...
            <a-form-item label="账户名称" name="remark" :rules="[{ required: true, message: '请输入' }]">
                <a-input v-model:value="formState.remark" placeholder="请输入" />
            </a-form-item>
            <a-form-item label="钱包名称" name="remark" :rules="[{ required: true, message: '请输入' }]">
                <a-input v-model:value="formState.remark" placeholder="请输入" />
            </a-form-item>
            <a-form-item label="钱包ID" name="remark" :rules="[{ required: true, message: '请输入' }]">
                <a-input v-model:value="formState.remark" placeholder="请输入" />
            </a-form-item>
            <a-form-item label="来源信息" name="remark" :rules="[{ required: true, message: '请输入' }]">
                <a-input v-model:value="formState.remark" placeholder="请输入" />
            </a-form-item>
            <a-form-item label="钱包品牌" name="remark" :rules="[{ required: true, message: '请输入' }]">
                <a-input v-model:value="formState.remark" placeholder="请输入" />
            </a-form-item>
            <a-form-item label="钱包名称" name="remark" :rules="[{ required: true, message: '请输入' }]">
                <a-input v-model:value="formState.remark" placeholder="请输入" />
            </a-form-item>
            <a-form-item label="审核内容" name="remark" :rules="[{ required: true, message: '请输入' }]">
                <a-input v-model:value="formState.remark" placeholder="请输入" />
            </a-form-item>
        </a-form>
    </a-modal>
