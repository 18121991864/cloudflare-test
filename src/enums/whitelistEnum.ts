...
export const commonLevelEnumMap = new Map<commonLevelEnum, ICommonLevel>([
    ...
    [
        commonLevelEnum.Primary,
        { label: '初级认证', value: commonLevelEnum.Primary }
    ],
    [
        commonLevelEnum.Advanced,
        { label: '高级认证', value: commonLevelEnum.Advanced }
    ]
]);
...
export const whitelistStateEnumMap = new Map<
  whitelistStateEnum,
  IWhitelistState
>([
    [
